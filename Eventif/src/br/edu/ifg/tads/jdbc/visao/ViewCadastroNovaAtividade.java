...
public class ViewCadastroNovaAtividade extends JDialog {
	...
	public ViewCadastroNovaAtividade() {
		...
		btnSalvar.setFont(new Font("URW Chancery L", Font.BOLD, 20));
		btnSalvar.setBounds(518, 340, 96, 25);
		panel.add(btnSalvar);
