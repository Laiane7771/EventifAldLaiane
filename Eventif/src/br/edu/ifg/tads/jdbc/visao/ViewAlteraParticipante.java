...
public class ViewAlteraParticipante {
	...
	public ViewAlteraParticipante() {
		...
		JLabel lblEndereco = new JLabel("Estado:");
		lblEndereco.setBounds(469, 332, 70, 15);
		...
		btnAlterar.setBounds(658, 426, 117, 25);
		panel.add(btnAlterar);
		 ...
		 btnCancelar.setBounds(529, 426, 117, 25);
